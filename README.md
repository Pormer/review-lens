...
**현재 제공 범위: 로컬 실행 버전.** 사용자 선택에 따라 공개 호스팅과 쇼핑몰별 수집 확장은 보류했습니다. AI는 Ollama를 유지하며, OpenAI 전환은 명시적 요청이 있을 때만 진행합니다. [현재 PC에서 사용·재실행하기](docs/LOCAL_USE.md). 상품 분류·요약 정확도와 원문 수집에는 알려진 한계가 있습니다.
