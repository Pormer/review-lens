...
function renderReport(job) {
  ...
  $("#report-content").innerHTML = `
    ...
    ${r.collection_stats ? `<div class="notice">자료 수집: 출처 ${Number(r.collection_stats.discovered_sources)}개 · 본문 확보 ${Number(r.collection_stats.readable_pages)}개 · AI 검토 ${Number(r.collection_stats.processed_sources)}개 · 검증 통과 근거 ${Number(r.collection_stats.accepted_evidence)}건</div>` : ""}
